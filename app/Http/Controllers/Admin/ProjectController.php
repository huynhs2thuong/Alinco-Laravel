...
class ProjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $posts = Project::where('address',NULL)->where('render',NULL)->orderBy('created_at','desc')->orderBy('id','desc')->get();
        ...
        //     // # Pagination
        //     $posts = $query->where('address',NULL)->where('render',NULL)->skip($request->start)->take($request->length)->get();
        //     # Output
        //     $rows = [];
        ...
        //     ]);
        // }
        return view('admin.project.index', compact('categories','posts'));
    ...
    public function create()
    {
        ...
        return view('admin.project.create', compact('post', 'categories','investImg','create','overviewImg','list_page','mcat_id'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::orderBy('id', 'desc')->where('type','project')->whereNotIn('id',['6'])->get(['id', 'title']);
       ...
       // $mcat_id = Category::whereIn('id', $mcat_id)->get();
        ...
        $list_page = Page::orderBy('id', 'desc')->where('id_pro','1')->get()->pluck('title', 'id')->all();// get list chương trình
        //var_dump($render);die;
        return view('admin.project.edit', compact('post', 'categories', 'gallery','investImg','overviewImg','list_page','mcat_id'));
    }
