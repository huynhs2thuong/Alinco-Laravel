...
class ModuleController extends Controller
{
    ...
    public function store(SaveModule $request)
    {
        ...
        $data['meta_title_vn'] = NULL;
        $data['meta_title_en'] = NULL;
        $data['meta_desc_vn'] = NULL;
        $data['meta_desc_en'] = NULL;
        $data['meta_keyword_vn'] = NULL;
        $data['meta_keyword_en'] = NULL;
        $data['client'] = 1;
        $data['cid'] = 123;
        if($request->cid){
    ...
    public function edit($id)
    {
        ...
        $module = Module::select('*')->where('id',$id)->firstOrFail();
