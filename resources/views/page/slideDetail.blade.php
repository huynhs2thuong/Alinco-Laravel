...
<div id="body-wrapper">
    <section id="work-detail" class="work-detail">
        ...
        <div class="work-detail-content custom-container">
            <nav class="modal-list col-12 pl-0">
                <div class="nav nav-tabs justify-content-start animate__fadeIn wow" id="nav-tab" role="tablist">
                @foreach($categories as $cat)
                        <a class="nav-item nav-link {{ ($cat->id === $projects->cat_id) ? 'active' : '' }}" href="{{ action('SiteController@work') }}/{{ $cat->slug }}" class="nav-item nav-link" id="nav-urban-tab" role="tab" aria-controls="nav-urban" aria-selected="true">{{$cat->title}}</a>
                @endforeach
                </div>
            </nav>
            <div class="row px-0 mx-0">
                ...
                <div class="work-detail-content-image col-12 col-sm-8 order-1 order-sm-2">
                ...
                <div class="work-detail-content-related col-12 order-3">
                    ...
                    <div class="col-12 related-slider">
                        @foreach( $data_img['related'] as $related)
                            <a class="related-slider-item related-{{$related->id}}" href="{{ action('SiteController@work') }}/{{ $related->id }}">
