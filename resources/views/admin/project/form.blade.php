<div class="primary col s9">
    <h1 class="text-capitalize">
        @if ($post->id)
            @lang('admin.title.edit', ['object' => trans('admin.object.project')])
        ...
        @else
            @lang('admin.title.create', ['object' => trans('admin.object.project')])
        @endif
    </h1>
    ...
    <div class="input-field" style="display: none;">
        @include('partials.lang_input', ['type' => 'text', 'attr' => "excerpt", 'model' => 'post', 'title' => trans('admin.field.excerpt')])
    </div>
    <div class="input-field">
...
<div class="side col s3">
    <div class="cat-top card hoverable">
        ...
        <div class="status">
            ...
            <p style="display: none;"> Số thứ tự: {{ Form::text('ordering', $post->ordering, array('class' => 'field inline-form ordering-input')) }}</p>
            @if ($post->id)
    ...
    <div class="cat-middle card hoverable">
        ...
        <div class="divider"></div>
            ...
            <p>
                {{ Form::checkbox('mcat_id[]', $category->id, (in_array($category->id,$mcat_id)), ['id' => 'category-' . $loop->index]) }}
    ...
    <div class="cat-bottom card hoverable">
        ...
        <div class="postimagediv2">
            ...
            <div class="clearfix"></div>
            <a class="btn waves-effect waves-light cyan {{ $post->resource_id ? 'hide' : '' }} set-image modal-trigger" href="#modal-upload2">@lang('admin.button.set image')</a>
            <a class="btn waves-effect waves-light cyan {{ $post->resource_id ? '' : 'hide' }} remove-image2">@lang('admin.button.remove image')</a>
        </div>
    </div>
    <div class="cat-bottom card hoverable">
        <h2 class="text-capitalize">Hình ảnh chi tiết dự án</h2>
        <div class="divider"></div>
