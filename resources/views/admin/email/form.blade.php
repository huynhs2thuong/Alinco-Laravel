<div class="primary col s9">
    <h1 class="text-capitalize">
        @if ($post->id)
            @lang('admin.title.edit', ['object' => trans('admin.object.email')])
        @else
            @lang('admin.title.create', ['object' => trans('admin.object.email')])
        @endif
    </h1>
    <div class="input-field">
        @include('partials.lang_input', ['type' => 'text', 'model' => 'post', 'attr' => 'title', 'title' => trans('admin.field.email')])
    </div>
    <div class="input-field" style="display: none;">
        @include('partials.lang_input', ['type' => 'text', 'model' => 'post', 'attr' => 'slug', 'title' => trans('admin.field.phone')])
    </div>
    <div class="input-field">
        @include('partials.lang_input', ['type' => 'textarea', 'attr' => "description", 'model' => 'post', 'class' => 'materialize-textarea', 'title' => trans('admin.field.description')])
    </div>
    <div class="input-field" style="display: none;">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.btn-preview').click(function(event) {
                ...
                $form.attr({
                    action: '{{ action('Admin\EmailController@preview') }}',
