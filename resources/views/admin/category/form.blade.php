<div class="primary col s9">
	<h1 class="text-capitalize">
        @if ($category->id)
            ...
            <a style="display: none;" href="{{ action('Admin\CategoryController@create') }}?type={{$category->type}}" class="page-title-action btn waves-effect waves-light cyan">@lang('admin.title.create raw')</a>
        @else
