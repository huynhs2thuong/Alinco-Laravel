<div class="post col s9">
    <h1 class="text-capitalize">
        @if ($page->id)
            @lang('admin.title.edit', ['object' => trans('admin.object.faq')])
        ...
        @else
            @lang('admin.title.create', ['object' => trans('admin.object.faq')])
        @endif
    </h1>
    <div class="input-field">
        @include('partials.lang_input', ['type' => 'text', 'model' => 'page', 'attr' => 'title', 'title' => trans('admin.field.giai_thuong')])
    </div>
    ...
    <h3 class="title" style="display: none;">Gallery</h3>
    <p style="display: none;"><a class="btn waves-effect waves-light cyan set-image modal-trigger" href="#modal-gallery">@lang('admin.button.set image')</a></p>
    <ul id="bar" class="gallery block__list block__list_tags row" style="display: none;">
        @if ($page->id)
...
<div class="modal" id="modal-gallery" style="display: none;">
