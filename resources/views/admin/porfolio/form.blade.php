<div class="primary col s9">
    <h1 class="text-capitalize">
        @if ($post->id)
            @lang('admin.title.edit', ['object' => trans('admin.object.porfolio')])
        @else
            @lang('admin.title.create', ['object' => trans('admin.object.porfolio')])
        @endif
    </h1>
    ...
    <div class="input-field" style="display: none;">
        @include('partials.lang_input', ['type' => 'text', 'model' => 'post', 'attr' => 'slug', 'title' => trans('admin.field.phone')])
    </div>
    <div class="input-field">
        @include('partials.lang_input', ['type' => 'textarea', 'attr' => "description", 'model' => 'post', 'class' => 'materialize-textarea', 'title' => trans('admin.field.address')])
    </div>
    <div class="input-field">
        @include('partials.lang_input', ['type' => 'textarea', 'attr' => "excerpt", 'model' => 'post', 'class' => 'materialize-textarea', 'title' => trans('admin.field.phone')])
    </div> -->
    <div class="input-field">
        @include('partials.lang_input', ['type' => 'text', 'model' => 'post', 'attr' => 'title', 'title' => trans('admin.field.title')])
    </div>
    <div class="input-field">
        @include('partials.lang_input', ['type' => 'text', 'model' => 'post', 'attr' => 'slug', 'title' => trans('admin.field.file')])
    </div>
    <div class="input-field" style="display: none;">
        @include('partials.lang_input', ['type' => 'text', 'attr' => "description", 'model' => 'post', 'title' => trans('admin.field.file')])
    </div>
    <div class="form-group">
    @include('partials.lang_input', [ 'type' => 'file', 'model' => 'post', 'title' => trans('File')])
    <br/>
    {{ csrf_field() }}
        <a  class="input-field" href="{{ url('/') }}/{{$post->content_vn}}" target="_blank">{{$post->slug}}.pdf</a>
        </br></br>
